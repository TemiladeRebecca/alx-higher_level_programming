...
If either of m_a or m_b contains rows of different lengths, a TypeError is raised with the message each row of m_a should be of the same size or each row of m_b should be of the same size.
